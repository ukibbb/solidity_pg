...
abstract contract ResultsConsumer is FunctionsClient {
    ...
    event RequestedResult(uint256 gameId, bytes32 requestId);
    ...
    function _requestResult(
        ...
        pending[requestId] = PendingRequest({gameId: gameId});
        emit RequestedResult(gameId, requestId);
    }
    ...
    function fulfillRequest(
        ...
        _processResult(request.gameId, response);
    }
}
