...
contract NativeTokenReceiver is ProgrammableTokenReceiver {
    ...
    function _swapExchangeTokenToNative(
        ...
        nativeTokenAmount = ISwapRouter(uniswapV3Router).exactInputSingle(
            params
        );
